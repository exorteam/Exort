...
@Service
public class AssoMemManagerServiceImpl implements AssoMemManagerService {
    ...
    public ApiResponse adoptApplication(CallbackParam<ApplicationDepartmentInfo> callbackParam) {
        ...
        String url = "http://202.120.40.8:30724/application/accept";
...
//            System.out.println(apiResponse);
    ...
    public ApiResponse<List<Department>> getDepartmentTree(int associationId) {
        ...
        String url = "http://202.120.40.8:30724/associations/" + associationId + "/departments";
    ...
    public ApiResponse<Department> getSpecDepartmentInfo(int associationId, int departmentId) {
        ...
        HttpMethod method = HttpMethod.GET;
        HttpEntity entity = new HttpEntity(headers);
        String url = "http://202.120.40.8:30724/associations/" + associationId + "/departments/" + departmentId;
    ...
    public ApiResponse<List<Integer>> getSpecMemberList(int associationId, int departmentId) {
        ...
        HttpMethod method = HttpMethod.GET;
        HttpEntity entity = new HttpEntity(headers);
        String url = "http://202.120.40.8:30724/associations/" + associationId + "/departments/" + departmentId + "/members";
...
//            System.out.println(e);
    ...
    public ApiResponse<Boolean> removeOneFromDepartment(int associationId, int departmentId, int userId) {
        ...
        HttpEntity requestEntity = new HttpEntity(headers);
        String url = "http://202.120.40.8:30724/associations/" + associationId + "/departments/" + departmentId + "/members/" + userId;
...
//            System.out.println(e);
    ...
    public ApiResponse<Boolean> checkUserPermissionInAssociation(int associationId, int userId, String permission) {
        ...
        HttpMethod method = HttpMethod.GET;
        HttpEntity entity = new HttpEntity(headers);
        String url = "http://202.120.40.8:30724/associations/" + associationId + "/members/" + userId + "/permissions/" + permission;
    ...
    public ApiResponse<List<Integer>> getUserAssociation(int userId) {
        ...
        HttpMethod method = HttpMethod.GET;
        HttpEntity entity = new HttpEntity(headers);
        String url = "http://202.120.40.8:30724/users/" + userId + "/associations";
    ...
    public ApiResponse<List<Department>> getUserDepartment(int associationId, int userId) {
        ...
        HttpMethod method = HttpMethod.GET;
        HttpEntity entity = new HttpEntity(headers);
        String url = "http://202.120.40.8:30724/users/" + userId + "/associations/" + associationId + "/departments";
    ...
    public ApiResponse<Boolean> deleteOneInAssociation(int associationId, int userId) {
        ...
        HttpMethod method = HttpMethod.DELETE;
        HttpEntity entity = new HttpEntity(headers);
        String url = "http://202.120.40.8:30724/associations/" + associationId + "/members/" + userId;
    ...
    public ApiResponse<Boolean> addOneToAssociation(int associationId, int userId) {
        ...
        String url = "http://202.120.40.8:30724/associations/" + associationId + "/members";
    ...
    public ApiResponse<Boolean> initDepartment(InitAssociationInfo initAssociationInfo) {
        ...
        String url = "http://202.120.40.8:30724/associations";
