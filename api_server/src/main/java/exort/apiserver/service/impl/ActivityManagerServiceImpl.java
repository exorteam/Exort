...
public class ActivityManagerServiceImpl implements ActivityManagerService {
    ...
    public Response createNewActivity(Activity activity) {
        ...
        ResponseEntity<Response> response = rt.exchange("http://202.120.40.8:30727/activities", method, requestEntity,
                Response.class);
    ...
    public Response updateActivity(Activity activity, String activityid) {
        ...
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<Activity> requestEntity = new HttpEntity<>(activity, headers);
        ResponseEntity<Response> response = rt.exchange("http://202.120.40.8:30727/activities/" + activityid, method,
    ...
    public Response getActivities(Select select, int pagesize, int pagenum, int sortby) {
        ...
        ResponseEntity<Response> response = rt.exchange(
                "http://202.120.40.8:30727/activities" + "?pagesize=" + Integer.toString(pagesize) + "&pagenum="
                        + Integer.toString(pagenum) + "&sortby=" + Integer.toString(sortby),
                method, requestEntity, Response.class);
        return response.getBody();
    }
    ...
    public Response addParticipants(String activityid, List<Integer> participantIds) {
        ...
        ResponseEntity<Response> response = rt.exchange(
                "http://202.120.40.8:30727/activities/" + activityid + "/participants", method, requestEntity,
                Response.class);
        return response.getBody();
    }
    ...
    public Response addRealParticipants(String activityid, List<Integer> realParticipantIds) {
        ...
        ResponseEntity<Response> response = rt.exchange(
                "http://202.120.40.8:30727/activities/" + activityid + "/realparticipants", method, requestEntity,
                Response.class);
        return response.getBody();
    }
    ...
    public Response getActivityParticipants(int pagesize, int pagenum, String activityid,
        ...
        HttpEntity<List<Integer>> requestEntity = new HttpEntity<>(participantIds, headers);
        ResponseEntity<Response> response = rt.exchange(
                "http://202.120.40.8:30727/activities/" + activityid + "/participants" + "?pagesize="
                        + Integer.toString(pagesize) + "&pagenum=" + Integer.toString(pagenum),
                method, requestEntity, Response.class);
        return response.getBody();
    }

    public Response getActivityRealParticipants(int pagesize, int pagenum, String activityid,
            List<Integer> realParticipantIds) {
        HttpHeaders headers = new HttpHeaders();
        HttpMethod method = HttpMethod.GET;
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<List<Integer>> requestEntity = new HttpEntity<>(realParticipantIds, headers);
        ResponseEntity<Response> response = rt.exchange(
                "http://202.120.40.8:30727/activities/" + activityid + "/realparticipants" + "?pagesize="
                        + Integer.toString(pagesize) + "&pagenum=" + Integer.toString(pagenum),
                method, requestEntity, Response.class);
        return response.getBody();
    }
    ...
    public Response acceptSignup(Operation operation) {
        ...
        ResponseEntity<Response> response = rt.exchange("http://202.120.40.8:30727/callback/acceptsignup", method,
                requestEntity, Response.class);
        return response.getBody();
    }
