...
<script>
  ...
  export default {
    ...
    methods: {
      findUser(){
        let info = this.$qs.stringify({'username': this.formCustom.name, 'password': this.formCustom.passwd});
        ...
        this.axios({
          ...
          // if (userType === 0) {
          //   that.$router.push({name: "activity"});
          //   // this.$Message.success("W")
          // } else {
          //   that.$router.push({name: "AssoList"});
          // }
