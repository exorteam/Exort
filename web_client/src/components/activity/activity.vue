        ...
        <div>
            <div style="margin-top: 15px; margin-left: 20px">
                ...
                <DatePicker v-model="select.createTime" type="daterange" split-panels placeholder="Select date"
                            style="width: 180px; margin-right: 50px"></DatePicker>
                报名时间<!-- 活动报名时间搜索 -->
                ...
                <b-form-select v-model="select.publishSelected" :options="publishSelectList"
                               style="width: 120px; height: 32px; margin-right: 50px"></b-form-select>
                报名状态<!-- 根据活动报名状态搜索 -->
                <b-form-select v-model="select.signupSelected" :options="signupSelectList"
                               style="width: 120px; height: 32px; margin-right: 50px"></b-form-select>
                活动状态<!-- 根据活动状态搜索 -->
