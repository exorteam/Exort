<template>
<div>
    <Button icon="md-add" @click="perm_creating = true; perm_editing_show = true;" style="margin-bottom: 8px">New</Button>
    <Row>
        <Col span="4">
        ...
        <Col>
            <Row type="flex">
                <Card style="margin: 0 0 8px 8px; width: 360px;" v-for="perm in cat_permissions[active_name]" :key="perm.id">
